...
public class CategoriesServiceImpl implements CategoriesService {
    ...
    public List<Category> filterCategories(String name, String select) {
        ...
        if (select != null) {
            if (select.equals("1")) {
                categories.sort(Comparator.comparing(com.OLearning.entity.Category::getName, String.CASE_INSENSITIVE_ORDER));
            } else if (select.equals("2")) {
                categories.sort(Comparator.comparing(com.OLearning.entity.Category::getName, String.CASE_INSENSITIVE_ORDER).reversed());
            }
        }
