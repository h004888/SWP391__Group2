...
@Service
public class InstructorCourseServiceImpl implements CourseService {
    ...
    public void createCourse(CourseAddDTO courseAddDTO) {
        courseAddDTO.setUserId(3L);
        Course course = instructorCourseMapper.MapCourseAdd(courseAddDTO);
