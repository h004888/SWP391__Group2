...
!function (t, e) {
    ...
    var x = function () {
        ...
        return r(t, [{
            ...
            key: "getPrimeFactors", value: function (t) {
                for (var e = [], i = 2; t >= 2;) t % i == 0 ? (e.push(i), t /= i) : i++;
                return e
            }
        }, {
            key: "mod", value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 7,
                    a = Math.pow(10, i - Math.floor(Math.log10(Math.max(t, e))));
        ...
        return r(t, [{
            ...
            key: "dropShadow", value: function (t, e) {
                var i, a, s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, r = e.top, o = e.left,
                    n = e.blur, l = e.color, h = e.opacity, c = e.noUserSpaceOnUse, d = this.w;
        ...
        return r(t, [{
            ...
            key: "renderPaths", value: function (t) {
                ...
                if (z.attr("index", s), x && z.attr({"clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")")}), "none" !== A.config.states.normal.filter.type) S.getDefaultFilter(z, s); else if (A.config.chart.dropShadow.enabled && k) {
            ...
            key: "createGroupWithAttributes", value: function (t, e, i, a) {
                var s = this.group();
                return i.forEach((function (t) {
                    return s.add(t)
                })), s.attr({class: a.class ? a.class : "", cy: e, cx: t}), s
            }
        }, {
            key: "drawPlus", value: function (t, e, i, a) {
                var s = i / 2,
            ...
            key: "drawX", value: function (t, e, i, a) {
                var s = i / 2,
            ...
            key: "drawMarker", value: function (t, e, i) {
                ...
                if ("X" === (null == i ? void 0 : i.shape) || "x" === (null == i ? void 0 : i.shape)) s = this.drawX(t, e, a, i); else if ("plus" === (null == i ? void 0 : i.shape) || "+" === (null == i ? void 0 : i.shape)) s = this.drawPlus(t, e, a, i); else if ("square" === i.shape || "rect" === i.shape) {
        ...
        return r(t, [{
            ...
            key: "checkComboSeries", value: function (t, e) {
                var i = !1, a = 0, s = 0;
                ...
                })), s > 0 && (i = !0), {comboBarCount: a, comboCharts: i}
            }
        }, {
        ...
        return r(t, [{
            ...
            key: "getY1Y2", value: function (t, e) {
                ...
                if (this.annoCtx.invertAxis) {
                    ...
                    if (r.config.yaxis[e.yAxisIndex].logarithmic) h = (a = new y(this.annoCtx.ctx).getLogVal(r.config.yaxis[e.yAxisIndex].logBase, a, c)) / r.globals.yLogRatio[c]; else h = (a - r.globals.minYArr[c]) / (r.globals.yRange[c] / r.globals.gridHeight);
                ...
                return "string" == typeof a && a.indexOf("px") > -1 && (i = parseFloat(a)), {yP: i, clipped: s}
            }
        }, {
            key: "getX1X2", value: function (t, e) {
                var i, a = "x1" === t ? e.x : e.x2, s = this.w,
                    r = this.annoCtx.invertAxis ? s.globals.minY : s.globals.minX,
                    o = this.annoCtx.invertAxis ? s.globals.maxY : s.globals.maxX,
                    n = this.annoCtx.invertAxis ? s.globals.yRange[0] : s.globals.xRange, l = !1;
        ...
        return r(t, [{
            key: "addXaxisAnnotation", value: function (t, e, i) {
                var a, s = this.w, r = this.helpers.getX1X2("x1", t), o = r.x, n = r.clipped, l = !0, h = t.label.text,
                    c = t.strokeDashArray;
                if (x.isNumber(o)) {
                    ...
                    if (!n || !l) {
                        ...
                        v.attr({rel: i}), e.appendChild(v.node), this.annoCtx.helpers.setOrientations(t, i)
                    }
                }
            }
        }, {
        ...
        return r(t, [{
            ...
            key: "defaultYFormatter", value: function (t, e, i) {
                var a = this.w;
                if (x.isNumber(t)) if (0 !== a.globals.yValueDecimal) t = t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal); else {
                    var s = t.toFixed(0);
                    t = t == s ? s : t.toFixed(1)
                }
                return t
        ...
        return r(t, [{
            key: "getLabel", value: function (t, e, i, a) {
                var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                    ...
                    d = n.config.xaxis.labels.formatter, g = !1, u = new S(this.ctx), p = l;
                o && (h = u.xLabelFormat(c, l, p, {
                    i: a,
                    dateFormatter: new A(this.ctx).formatDate,
                    w: n
                }), void 0 !== d && (h = d(l, t[a], {i: a, dateFormatter: new A(this.ctx).formatDate, w: n})));
                var f, x;
            ...
            key: "yAxisAllSeriesCollapsed", value: function (t) {
            ...
            key: "translateYAxisIndex", value: function (t) {
        ...
        return r(t, [{
            key: "addYaxisAnnotation", value: function (t, e, i) {
                var a, s = this.w, r = t.strokeDashArray, o = this.helpers.getY1Y2("y1", t), n = o.yP, l = o.clipped,
                    h = !0, c = !1, d = t.label.text;
        ...
        return r(t, [{
            key: "addPointAnnotation", value: function (t, e, i) {
                if (!(this.w.globals.collapsedSeriesIndices.indexOf(t.seriesIndex) > -1)) {
                    var a = this.helpers.getX1X2("x1", t), s = a.x, r = a.clipped,
                    ...
                    if (x.isNumber(s) && !n && !r) {
                        ...
                        if (d.attr({rel: i}), e.appendChild(d.node), t.customSVG.SVG) {
                            ...
                            g.attr({transform: "translate(".concat(s + t.customSVG.offsetX, ", ").concat(o + t.customSVG.offsetY, ")")}), g.node.innerHTML = t.customSVG.SVG, e.appendChild(g.node)
                        }
                        if (t.image.path) {
    ...
    var M = {
        ...
        return r(t, [{
            ...
            key: "addAnnotationExternal", value: function (t) {
                var e = t.params, i = t.pushToMemory, a = t.context, s = t.type, r = t.contextMethod, o = a, n = o.w,
                    ...
                    h = l.childNodes.length + 1, c = new I,
                    ...
                    tooltip: {
                        shared: !1, followCursor: !0, custom: function (t) {
                            return t.w.config.plotOptions && t.w.config.plotOptions.bar && t.w.config.plotOptions.bar.horizontal ? function (t) {
                                var i = z(e(e({}, t), {}, {isTimeline: !0})), a = i.color, s = i.seriesName,
        ...
        return r(t, [{
            ...
            key: "drawPoint", value: function (t, e, i, a, s, r, o) {
                var n = this.w, l = s, h = new b(this.ctx), c = new v(this.ctx), d = new H(this.ctx),
                    g = new D(this.ctx), u = new m(this.ctx), p = g.getMarkerConfig({
        ...
        return r(t, [{
            ...
            key: "drawDataLabel", value: function (t) {
                ...
                for (var x = 0; x < a.x.length; x++) if (g = a.x[x] + d.offsetX, u = a.y[x] + d.offsetY + l, !isNaN(g)) {
                    ...
                    if ("bubble" === h.config.chart.type) v = y(b = h.globals.seriesZ[s][p]), u = a.y[x], u = new O(this.ctx).centerTextInBubble(u, s, p).y; else void 0 !== b && (v = y(b));
        ...
        return r(t, [{
            ...
            key: "toggleSeriesOnHover", value: function (t, e) {
                ...
                if ("mousemove" === t.type) {
                    ...
                    } else r = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(s + 1, "']")); else r = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(s + 1, "'] path"));
        ...
        return r(t, [{
            ...
            key: "parseDataAxisCharts", value: function (t) {
                var e, i = this, a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx,
                    s = this.w.config, r = this.w.globals, o = new A(a),
        ...
        return r(t, [{
            key: "niceScale", value: function (t, e) {
                var i, a, s, r, o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, n = 1e-11,
                    l = this.w, h = l.globals;
                ...
                if (s && r) {
                    ...
                    if (d) if (c) if (0 != x.mod(b, v)) {
                        var C = x.getGCD(v, S);
                        v = S / C < 10 ? C : S
                    } else 0 == x.mod(v, S) ? v = S : (S = v, d = !1); else v = S; else if (c) 0 == x.mod(b, v) ? S = v : v = S; else if (0 == x.mod(b, v)) S = v; else {
                        S = b / (f = Math.ceil(b / v));
                        var L = x.getGCD(b, v);
                        b / L < a && (S = L), v = S
                    }
        ...
        return r(t, [{
            ...
            key: "setYRange", value: function () {
                ...
                return t.isMultipleYAxis ? (this.scales.scaleMultipleYAxes(), t.minY = a) : (t.barGroups = [], e.series.forEach((function (i) {
                    ...
                    return i.indexOf(t) === e
                })), this.scales.setYScaleForIndex(0, t.minY, t.maxY), t.minY = t.yAxisScale[0].niceMin, t.maxY = t.yAxisScale[0].niceMax, t.minYArr[0] = t.yAxisScale[0].niceMin, t.maxYArr[0] = t.yAxisScale[0].niceMax, t.seriesYAxisMap = [t.series.map((function (t, e) {
                    return e
        ...
        return r(t, [{
            ...
            key: "getTotalYAxisWidth", value: function () {
                var t = this.w, e = 0, i = 0, a = 0, s = t.globals.yAxisScale.length > 1 ? 10 : 0,
                    r = new C(this.dCtx.ctx), o = function (o, n) {
        ...
        return r(t, [{
            ...
            key: "hideSeries", value: function (t) {
                ...
                if (s.axisCharts) {
                    ...
                    }), s.ancillaryCollapsedSeriesIndices.push(i)); else if (s.collapsedSeriesIndices.indexOf(i) < 0) {
                ...
                } else s.collapsedSeries.push({index: i, data: r[i]}), s.collapsedSeriesIndices.push(i);
        ...
        return r(t, [{
            ...
            key: "seriesHoverByContext", value: function (t) {
                ...
                if (o) {
                    ...
                    }, i.e = s, i.tooltipUtil.hasBars() && !r.globals.comboCharts && !i.isBarShared) if (this.tConfig.onDatasetHover.highlightDataSeries) new W(e).toggleSeriesOnHover(s, s.target.parentNode);
            ...
            key: "create", value: function (t, i, a, s, r) {
                ...
                if (S.config.legend.tooltipHoverFormatter) {
                    ...
                    for (var T = 0; T < I.length; T++) {
                        var z = I[T], X = parseInt(z.getAttribute("i"), 10),
                            E = decodeURIComponent(z.getAttribute("data:default-text")),
                            Y = M(E, {seriesIndex: A ? X : a, dataPointIndex: s, w: S});
        ...
        return r(t, [{
            key: "handleBarDataLabels", value: function (t) {
                ...
                var k, A = null, S = e, C = i, L = {}, P = x.config.dataLabels, M = this.barCtx.barOptions.dataLabels,
            ...
            key: "drawCalculatedDataLabels", value: function (t) {
                ...
                var u = new N(this.barCtx.ctx), p = new m(this.barCtx.ctx), f = c.formatter, x = null,
        ...
        return r(t, [{
            ...
            key: "getPathFillColor", value: function (t, e, i, a) {
                var s, r, o, n, l = this.w, h = new H(this.barCtx.ctx), c = null,
            ...
            key: "barBackground", value: function (t) {
                var e = t.j, i = t.i, a = t.x1, s = t.x2, r = t.y1, o = t.y2, n = t.elSeries, l = this.w,
                    h = new m(this.barCtx.ctx), c = new W(this.barCtx.ctx).getActiveConfigSeriesIndex();
            ...
            key: "getYForValue", value: function (t, e, i) {
            ...
            key: "getGoalValues", value: function (t, i, a, s, r, n) {
                ...
                if (h.globals.seriesGoals[s] && h.globals.seriesGoals[s][r] && Array.isArray(h.globals.seriesGoals[s][r]) && h.globals.seriesGoals[s][r].forEach((function (t) {
                    ...
                    d(h.globals.seriesRangeStart[s][r], u), d(h.globals.seriesRangeEnd[s][r], e(e({}, u), {}, {strokeColor: Array.isArray(g[s]) ? g[s][1] : g[s]}))
                }
                return c
            }
        }, {
        ...
        return r(t, [{
            key: "draw", value: function (t, i) {
                ...
                for (var n = 0, l = 0; n < t.length; n++, l++) {
                    ...
                    var L = s.group({class: "apexcharts-datalabels", "data:realIndex": v});
                    a.globals.delayedElements.push({el: L.node}), L.node.classList.add("apexcharts-element-hidden");
                    var P = s.group({class: "apexcharts-bar-goals-markers"}),
                        M = s.group({class: "apexcharts-bar-shadows"});
                    a.globals.delayedElements.push({el: M.node}), M.node.classList.add("apexcharts-element-hidden");
                    for (var I = 0; I < t[n].length; I++) {
                        var T = this.barHelpers.getStrokeWidth(n, I, v), z = null, X = {
                            indexes: {i: n, j: I, realIndex: v, translationsIndex: S, bc: l},
                            x: u,
                            y: p,
                            strokeWidth: T,
                            elSeries: w
            ...
            key: "drawColumnPaths", value: function (t) {
                var e, i = t.indexes, a = t.x, s = t.y, r = t.xDivision, o = t.barWidth, n = t.zeroH, l = t.strokeWidth,
                    h = t.elSeries, c = this.w, d = i.realIndex, g = i.translationsIndex, u = i.i, p = i.j, f = i.bc;
                if (c.globals.isXNumeric) {
                    var x = this.getBarXForNumericXAxis({x: a, j: p, realIndex: d, barWidth: o});
                    a = x.x, e = x.barXPosition
                } else if (c.config.plotOptions.bar.hideZeroBarsWhenGrouped) {
                    var b = this.barHelpers.getZeroValueEncounters({i: u, j: p}), v = b.nonZeroColumns,
                        m = b.zeroEncounters;
        ...
        return r(s, [{
            key: "draw", value: function (t, i) {
                ...
                for (var o = this.graphics.group({class: "apexcharts-bar-series apexcharts-plot-series"}), n = 0, l = 0, h = function (r, h) {
                    ...
                    var w = a.graphics.group({class: "apexcharts-datalabels", "data:realIndex": v}),
                        k = a.graphics.group({class: "apexcharts-bar-goals-markers"}), A = 0, S = 0,
                    ...
                    for (var L = 0; L < s.globals.dataPoints; L++) {
                        var P = a.barHelpers.getStrokeWidth(r, L, v), M = {
                            indexes: {i: r, j: L, realIndex: v, translationsIndex: m, bc: h},
                            strokeWidth: P,
                            x: n,
                            y: l,
                            elSeries: y,
            ...
            key: "initialPositions", value: function (t, e, i, a, s, r, o) {
                var n, l, h = this.w;
                ...
                return {x: t, y: e, yDivision: a, xDivision: i, barHeight: n / c, barWidth: l / c, zeroH: s, zeroW: r}
            }
        }, {
            ...
            key: "drawStackedColumnPaths", value: function (t) {
                var e = t.indexes, i = t.x, a = t.y, s = t.xDivision, r = t.barWidth, o = t.zeroH, n = t.groupIndex,
                    l = t.seriesGroup, h = t.elSeries, c = this.w, d = e.i, g = e.j, u = e.bc, p = e.translationsIndex;
                if (c.globals.isXNumeric) {
        ...
        return r(s, [{
            key: "draw", value: function (t, i, a) {
                ...
                for (var c = o.group({class: "apexcharts-".concat(n, "-series apexcharts-plot-series")}), d = function (i) {
                    ...
                    for (var S = o.group({class: "apexcharts-datalabels", "data:realIndex": v}), C = function (a) {
                        var o = s.barHelpers.getStrokeWidth(i, a, v), c = null, x = {
                            indexes: {i: i, j: a, realIndex: v, translationsIndex: k},
                            x: u,
                            y: p,
                            strokeWidth: o,
                            elSeries: m
        ...
        return r(t, [{
            ...
            key: "calculateDataLabels", value: function (t) {
                var e = t.text, i = t.x, a = t.y, s = t.i, r = t.j, o = t.colorProps, n = t.fontSize,
                    l = this.w.config.dataLabels, h = new m(this.ctx), c = new N(this.ctx), d = null;
                if (l.enabled) {
        ...
        return r(t, [{
            ...
            key: "drawArcs", value: function (t, e) {
                var i = this.w, a = new v(this.ctx), s = new m(this.ctx), r = new H(this.ctx),
                ...
                for (var d = 0; d < t.length; d++) {
                    ...
                    if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 === (k = u / this.fullAngle * i.config.chart.animations.speed) && (k = 1), this.animDur = k + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(b, {
                        ...
                        if (0 !== u && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                            ...
                            var P = i.globals.dataLabels.style.colors[d], M = s.group({class: "apexcharts-datalabels"}),
                                I = s.drawText({
                                    x: A,
                                    y: S,
                                    text: C,
            ...
            key: "drawPolarElements", value: function (t) {
                var e = this.w, i = new _(this.ctx), a = new m(this.ctx), s = new Ct(this.ctx), r = a.group(),
                    o = a.group(), n = i.niceScale(0, Math.ceil(this.maxY), 0), l = n.result.reverse(),
                    h = n.result.length;
                this.maxY = n.niceMax;
        ...
        return r(i, [{
            ...
            key: "drawTracks", value: function (t) {
                var e = this.w, i = new m(this.ctx), a = i.group({class: "apexcharts-tracks"}), s = new v(this.ctx),
                    r = new H(this.ctx), o = this.getStrokeWidth(t);
                t.size = t.size - o / 2;
            ...
            key: "drawArcs", value: function (t) {
                var e = this.w, i = new m(this.ctx), a = new H(this.ctx), s = new v(this.ctx), r = i.group(),
                ...
                for (var f = p ? t.series.length - 1 : 0; p ? f >= 0 : f < t.series.length; p ? f-- : f++) {
                    ...
                    if (s.setSelectionFilter(M, 0, f), this.addListeners(M, this.radialDataLabels), b.add(M), M.attr({
                        ...
                        R.on("click", this.onBarLabelClick), R.attr({rel: f + 1}), 0 !== w && R.attr({
        ...
        return r(s, [{
            key: "draw", value: function (t, i) {
                ...
                for (var r = s.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), n = 0; n < t.length; n++) {
                    ...
                    for (var k = s.group({
                        class: "apexcharts-datalabels",
                        "data:realIndex": p
                    }), A = s.group({class: "apexcharts-rangebar-goals-markers"}), S = 0; S < a.globals.dataPoints; S++) {
                        var C, L = this.barHelpers.getStrokeWidth(n, S, p), P = this.seriesRangeStart[n][S],
                            M = this.seriesRangeEnd[n][S], I = null, T = null, z = null,
                            X = {x: g, y: u, strokeWidth: L, elSeries: f}, E = this.seriesLen;
                        ...
                        if (this.isHorizontal) {
                            ...
                            b = (I = this.drawRangeColumnPaths(e({
                                indexes: {
                                    ...
                                    realIndex: p,
                                    translationsIndex: y
                                }, barWidth: v, barXPosition: T, zeroH: c, xDivision: l
                            }, X))).barHeight
                        }
            ...
            key: "drawRangeColumnPaths", value: function (t) {
                var e = t.indexes, i = t.x, a = t.xDivision, s = t.barWidth, r = t.barXPosition, o = t.zeroH,
                    n = this.w, l = e.i, h = e.j, c = this.yRatio[e.translationsIndex], d = e.realIndex,
        ...
        return r(t, [{
            ...
            key: "determineFirstPrevY", value: function (t) {
                var e, i, a, s = t.i, r = t.realIndex, o = t.series, n = t.prevY, l = t.lineYPosition,
                    h = t.translationsIndex, c = this.w,
                ...
                return {prevY: n, lineYPosition: l}
            }
        }]), t
    }(), zt = function (t) {
    ...
    var Ft = function () {
        ...
        return r(t, [{
            key: "draw", value: function (t, i, a, s) {
                ...
                })), o.config.chart.stacked) for (var R = d.length; R > 0; R--) h.add(d[R - 1]); else for (var H = 0; H < d.length; H++) h.add(d[H]);
                return h
            }
        }, {
            ...
            key: "_calculatePathsFrom", value: function (t) {
                var e, i, a, s, r = t.type, o = t.series, n = t.i, l = t.realIndex, h = t.translationsIndex,
                    c = t.prevX, d = t.prevY, g = t.prevY2, u = this.w, p = new m(this.ctx);
                if (null === o[n][0]) {
            ...
            key: "_iterateOverDataPoints", value: function (t) {
                var e, i, a = this, s = t.type, r = t.series, o = t.iterations, n = t.realIndex,
                    l = t.translationsIndex, h = t.i, c = t.x, d = t.y, g = t.pX, u = t.pY, p = t.pathsFrom,
                    f = t.linePaths, b = t.areaPaths, v = t.seriesIndex, y = t.lineYPosition, w = t.xArrj, k = t.yArrj,
                    A = t.y2Arrj, S = t.isRangeStart, C = t.seriesRangeEnd, L = this.w, P = new m(this.ctx),
                    M = this.yRatio, I = p.prevY, T = p.linePath, z = p.areaPath, X = p.pathFromLine,
                    E = p.pathFromArea, Y = x.isNumber(L.globals.minYArr[n]) ? L.globals.minYArr[n] : L.globals.minY;
                ...
                for (var O, N = 0, W = 0; W < o; W++) {
                    ...
                    } else y = this.zeroY; else y = this.zeroY;
            ...
            key: "_createPaths", value: function (t) {
                ...
                t.realIndex;
                var s = t.j, r = t.x, o = t.y, n = t.xArrj, l = t.yArrj, h = t.y2, c = t.y2Arrj, d = t.pX, g = t.pY,
                    u = t.pathState, p = t.segmentStartX, f = t.linePath, x = t.areaPath, b = t.linePaths,
                    v = t.areaPaths, y = t.curve, w = t.isRangeStart;
                this.w;
                ...
                switch (y) {
                    case"monotoneCubic":
                        ...
                        switch (u) {
                            ...
                            case 2:
                                var M = w ? n : n.slice().reverse(), I = w ? P : P.slice().reverse(),
                    ...
                    case"smooth":
                        var R = .35 * (r - d);
                        if (null === i[a][s]) u = 0; else switch (u) {
                            case 0:
                            ...
                            case 1:
                                if (null === i[a][s + 1]) f += L ? A.line(d, h) : A.move(d, g), x += A.line(d, S) + A.line(p, S) + "z", b.push(f), v.push(x); else {
    ...
    var Rt, Ht, Dt = function () {
        ...
        return r(t, [{
            key: "draw", value: function (t) {
                var e = this, i = this.w, a = new m(this.ctx), s = new H(this.ctx),
        ...
        return r(t, [{
            ...
            key: "generateYearScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.daysWidthOnXAxis, r = t.numberOfYears,
                    o = e.minYear, n = 0, l = new A(this.ctx), h = "year";
            ...
            key: "generateMonthScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonthDate, a = t.currentMonth, s = t.currentYear,
                    r = t.daysWidthOnXAxis, o = t.numberOfMonths, n = a, l = 0, h = new A(this.ctx), c = "month", d = 0;
                if (e.minDate > 1) {
            ...
            key: "generateDayScale", value: function (t) {
                var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.hoursWidthOnXAxis, r = t.numberOfDays,
                    o = new A(this.ctx), n = "day", l = e.minDate + 1, h = l, c = function (t, e, i) {
            ...
            key: "generateHourScale", value: function (t) {
                var e = t.firstVal, i = t.currentDate, a = t.currentMonth, s = t.currentYear, r = t.minutesWidthOnXAxis,
                    o = t.numberOfHours, n = new A(this.ctx), l = "hour", h = function (t, e) {
            ...
            key: "formatDates", value: function (t) {
                ...
                return t.map((function (t) {
                    var a = t.value.toString(), s = new A(e.ctx), r = e.createRawDateString(t, a),
            ...
            key: "plotChartType", value: function (t, e) {
                ...
                if (s.comboCharts) {
                    ...
                    case"area":
                        ...
                        break;
                    case"bar":
                        if (a.chart.stacked) y = new wt(this.ctx, e).draw(s.series); else this.ctx.bar = new yt(this.ctx, e), y = this.ctx.bar.draw(s.series);
                        break;
                    case"candlestick":
    ...
    Rt = "undefined" != typeof window ? window : void 0, Ht = function (t, e) {
        ...
        a.PathArray = function (t, e) {
            ...
            a.listeners[n] = a.listeners[n] || {}, a.listeners[n][l] = a.listeners[n][l] || {}, a.listeners[n][l][h] = a.listeners[n][l][h] || {}, i._svgjsListenerId || (i._svgjsListenerId = ++a.listenerId), a.listeners[n][l][h][i._svgjsListenerId] = o, t.addEventListener(l, o, r || {passive: !1})
                ...
                case"A":
                    e = function (t, e) {
                        var i, a, s, r, o, n, l, h, c, d, g, u, p, f, x, b, v, m, y, w, k, A, S, C, L, P,
                            M = Math.abs(e[1]), I = Math.abs(e[2]), T = e[3] % 360, z = e[4], X = e[5], E = e[6],
                            Y = e[7], F = new SVG.Point(t), R = new SVG.Point(E, Y), H = [];
                        if (0 === M || 0 === I || F.x === R.x && F.y === R.y) return [["C", F.x, F.y, R.x, R.y, R.x, R.y]];
